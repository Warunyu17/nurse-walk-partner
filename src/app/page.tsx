        ...
        <>
            <div className="min-h-screen bg-gray-50 font-sans flex flex-col overflow-y-auto">
                ...
                <main className="container mx-auto px-4 sm:px-6 lg:px-8 mt-8 mb-8 flex-grow flex flex-col">
                    ...
                    {/* === ส่วน Feature Cards 4 อันล่าง === */}
                    <div className="mt-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8 pt-2 pb-8 lg:pb-0">
                        ...
                        {/* Card 2: ดูประวัติการประเมิน */}
                        <Link href="/history" className="flex flex-col items-center bg-white p-8 rounded-lg shadow-lg border border-gray-200 hover:shadow-xl transition-shadow cursor-pointer">
                            <div className="w-24 h-24 bg-gray-100 rounded-lg flex items-center justify-center border border-gray-300">
                                <FaHistory className="w-12 h-12 text-gray-600" />
                            </div>
                            <p className="mt-4 text-xl font-bold text-gray-800">ประวัติการประเมิน</p>
                        </Link>

                        {/* Card 3: การเตรียมความพร้อม */}
